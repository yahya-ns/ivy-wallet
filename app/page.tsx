...
import { ArrowRight, Sparkles, Plus, ArrowLeftRight } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-6 space-y-4">
          <div className="flex items-center justify-between px-1">
            ...
            <Link
              href="/transactions"
              className="text-xs font-semibold text-ivy-purple hover:underline flex items-center gap-1"
            >
              <span>View All</span>
              <ArrowRight size={14} />
            </Link>
